<div align="center">
  ...
  <img alt="Rust GlobalBoost logo by Hunter Trujillo, see license and source files under /logo" src="./logo/rust-bitcoin.png" width="300" />
  ...
  <p>
    <a href="https://crates.io/crates/globalboost"><img alt="Crate Info" src="https://img.shields.io/crates/v/bitcoin.svg"/></a>
    <a href="https://github.com/mendozg/rust-globalboost/blob/master/LICENSE"><img alt="MIT or Apache-2.0 Licensed" src="https://img.shields.io/badge/license-MIT%2FApache--2.0-blue.svg"/></a>
    <a href="https://github.com/mendozg/rust-globalboost/actions?query=workflow%3AContinuous%20integration"><img alt="CI Status" src="https://github.com/rust-bitcoin/rust-bitcoin/workflows/Continuous%20integration/badge.svg"></a>
...
* De/serialization of GlobalBoost protocol network messages
...
For JSONRPC interaction with GlobalBoost Core, it is recommended to use
[rust-globalboostcore-rpc](https://github.com/mendozg/rust-globalboostcore-rpc).
...
this library and the GlobalBoost Core reference implementation. In a consensus
based cryptocurrency such as GlobalBoost it is critical that all parties are
...
Currently can be found on [docs.rs/globalboost](https://docs.rs/globalboost/).
...
Patches which add support for non-GlobalBoost cryptocurrencies by adding constants
