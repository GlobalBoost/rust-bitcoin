...
mod test {
    ...
    const MSG_VERSION: [u8; 126] = [
        0xf2, 0xe2, 0xb2, 0xa2, 0x76, 0x65, 0x72, 0x73,
    ...
    const MSG_VERACK: [u8; 24] = [
        0xf2, 0xe2, 0xb2, 0xa2, 0x76, 0x65, 0x72, 0x61,
        0x63, 0x6b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x5d, 0xf6, 0xe0, 0xe2
    ];

    const MSG_PING: [u8; 32] = [
        0xf2, 0xe2, 0xb2, 0xa2, 0x70, 0x69, 0x6e, 0x67,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    const MSG_ALERT: [u8; 192] = [
        0xf2, 0xe2, 0xb2, 0xa2, 0x61, 0x6c, 0x65, 0x72,
