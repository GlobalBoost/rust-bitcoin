...
//!
//! assert_eq!(&bytes[..], &[0xF2, 0xE2, 0xB2, 0xA2]);
//! ```
...
mod tests {
    ...
    #[test]
    fn serialize_test() {
        assert_eq!(serialize(&Network::Bitcoin.magic()), &[0xa2, 0xb2, 0xe2, 0xf2]);
        ...
        assert_eq!(deserialize(&[0xa2, 0xb2, 0xe2, 0xf2]).ok(), Some(Network::Bitcoin.magic()));
